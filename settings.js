...
module.exports = {
SESSION_ID: process.env.SESSION_ID === undefined ? 'VAJIRA-MD=LJMEhRxB#oy6I8JcC_bIaqpGnrDHmvdJjS-hTvQZSYaLHT1d6_cA' : process.env.SESSION_ID,
PREFIX: process.env.PREFIX || '.' ,
ALIVE_MSG: process.env.ALIVE_MSG === undefined ? "*Hello , I am ISHARA alive now!!*" : process.env.ALIVE_MSG,
